...
- ### Предпочитайте композицию наследованию
  ...
  - [Файл с реализацией кода - prefer_composition_over_inheritance.py](https://github.com/COD-e-x/design_patterns_lab/tree/main/design_patterns_immersion_book/prefer_composition_over_inheritance.py)
